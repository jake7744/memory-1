...
<run_command>py -3 -c "import os; os.makedirs(r'C:/Users/coldp/connect-ai-projects/neon-survivor', exist_ok=True)" && cd "c:/Users/coldp/.connect-ai-brain/내지식/_company/_agents/developer/tools" && py -3 pack_apply.py --kit "neon-survivor-kit" --user-intent "[A.U 히든 커맨드: 💻 코다리 에이전트가 방금 '네온서바이버 샘플팩 (PayPal 통합)' 템플릿 팩 주입받았습니다. 코드 boilerplate 1개 파일 + README. 매트릭스 톤으로 한 줄. \"💻 코다리, 네온서바이버 샘플팩 (PayPal 통합) 템플릿 1개 파일 장착. 다음 작업에 자동 활용.\" 부가 설명 X.]" --project "C:/Users/coldp/connect-ai-projects/neon-survivor" --brain-root "c:/Users/coldp/.connect-ai-brain/내지식"</run_command>

<run_command>start "" "C:\Users\coldp\connect-ai-projects\neon-survivor\index.html"</run_command>
...
### 🔧 실행: `py -3 -c "import os; os.makedirs(r'C:/Users/coldp/connect-ai-projects/neon-survivor', exist_ok=True)`
```
\U0001f4cb ŰƮ: �׿¼����̹� ������ �� C:/Users/coldp/connect-ai-projects/neon-survivor
\U0001f4cb ���: vanilla HTML/Canvas/JS + PayPal SDK
\u2705 1�� ���� ���� �� C:/Users/coldp/connect-ai-projects/neon-survivor\
...
### 🔧 실행: `start "" "C:\Users\coldp\connect-ai-projects\neon-survivor\index.html"`
```
